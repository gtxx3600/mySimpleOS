 ...
 * @param line      __LINE__
 *****************************************************************************/
PUBLIC void assertion_failure(char *exp, char *file, char *base_file, int line,PROCESS* p)
{
	printl("  assert(%s) failed: file: %s, base_file: %s, ln%d proc: %s", exp, file, base_file, line,p->name);
